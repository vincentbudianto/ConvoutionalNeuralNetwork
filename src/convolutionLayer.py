...
class ConvolutionLayer:
    ...
    def setConfigurationDefault(self, batchsize, batchperepoch, convFilterCount, convFilterSize, convPaddingSize, convStrideSize, detectorMode, poolFilterSize, poolStrideSize, poolMode):
        ...
        for i in range(convFilterCount):
            ...
            convolutionList.append(Convolution(batchsize, batchperepoch, None, convPaddingSize, convFilterSize, convFilterSize, convStrideSize, filters = dummyFilter))
    ...
    def updateWeight(self, learning_rate, momentum):
        for i in range(len(self.convolution)):
            self.convolution[i].updateFilters(learning_rate, momentum)
